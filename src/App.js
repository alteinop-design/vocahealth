      ...
      <div className="login-page__inner">
        ...
        <div className="login-card">
          ...
          {tab === 'login' ? (
            ...
            <form className="login-form" onSubmit={e => e.preventDefault()}>
              <h2 className="login-form__title">Get started free</h2>
              <p className="login-form__sub">14-day free trial — no credit card required</p>
              ...
              <p className="login-terms">
                By creating an account you agree to our <button type="button" className="form-forgot">Terms</button> and <button type="button" className="form-forgot">Privacy Policy</button>.
              </p>
            </form>
          )}
        </div>
        ...
        <p className="login-page__trust">
          <ShieldIcon /> HIPAA Compliant &bull; 256-bit Encrypted &bull; SOC 2 Certified
        </p>
      </div>
    </div>
  );
    ...
    <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
      <div className="navbar__inner">
        ...
        <div className="navbar__actions">
          ...
          <button className="btn btn--primary" onClick={onLoginClick}>Book a Demo</button>
        </div>
